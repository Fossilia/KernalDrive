...
public class mediaPlayer extends JFrame {
   ...
   private static String VIDEO_PATH; //= "Complete Podrace Grid Sequence.mkv";
...
public class mediaPlayer extends JFrame {
   ...
   public mediaPlayer(String path) {
      ...
      mediaPlayerComponent.mediaPlayer().fullScreen().strategy(new AdaptiveFullScreenStrategy(this));
      VIDEO_PATH = path;
      playpic = new ImageIcon("resources/icons/playIcon.png");
      fullpic = new ImageIcon("resources/icons/full.png");
